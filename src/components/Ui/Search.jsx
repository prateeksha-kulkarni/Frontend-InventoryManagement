...
const Input = ({ placeholder = "Search", type = "search", value, onChange }) => {
  return (
    <StyledWrapper>
      <div className="group">
...
const StyledWrapper = styled.div`
  ...
  .input {
   ...
   line-height: 28px;
   padding: 0 1rem;
   padding-left: 3rem; /* more space for icon and placeholder */
   ...
   transition: .3s ease;
   font-size: 1rem;
   text-overflow: ellipsis; /* ensures long placeholder/value is truncated */
   overflow: hidden;
   white-space: nowrap;
  }
